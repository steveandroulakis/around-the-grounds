...
class TestDateUtils:
    ...
    def test_parse_mm_dd_format(self) -> None:
    ...
    @freeze_time("2025-07-05")
    def test_parse_mm_dd_format_next_year(self) -> None:
    ...
    def test_parse_mm_slash_dd_slash_yyyy_format(self) -> None:
    ...
    def test_parse_mm_dash_dd_dash_yyyy_format(self) -> None:
        """Test parsing MM-DD-YYYY format."""
        result = DateUtils.parse_date_from_text("07-05-2025")
        assert result is not None
        assert result.month == 7
    ...
    def test_parse_none_text(self) -> None:
        ...
        result = DateUtils.parse_date_from_text("")  # Use empty string instead of None
        assert result is None

    def test_parse_time_range_pm(self) -> None:
        """Test parsing PM time range."""
        result = DateUtils.parse_time_from_text("1 — 8pm")
        assert result is not None
        assert result == (13, 20)  # 1pm-8pm in 24-hour format

    def test_parse_time_range_am(self) -> None:
        """Test parsing AM time range."""
        result = DateUtils.parse_time_from_text("8 — 11am")
        assert result is not None
        assert result == (8, 11)

    def test_parse_time_range_mixed(self) -> None:
    ...
    def test_parse_time_range_with_minutes(self) -> None:
    ...
    @freeze_time("2025-07-05")
    def test_is_within_next_week_boundary(self) -> None:
    ...
    @freeze_time("2025-07-05")
    def test_is_within_next_week_too_far(self) -> None:
    ...
    @freeze_time("2025-07-05")
    def test_is_within_next_week_past(self) -> None:
        """Test past date."""
    ...
    def test_parse_month_day_year_rollover(self) -> None:
    ...
    def test_parse_invalid_month_name(self) -> None:
