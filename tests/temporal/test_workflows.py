...
class TestActivitiesImport:
    ...
    def test_scrape_activities_import(self):
    ...
    def test_deployment_activities_import(self):
    ...
    def test_activities_have_methods(self):
