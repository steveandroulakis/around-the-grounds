...
class TestObecBrewingParser:
    ...
    async def test_parse_valid_food_truck_info(self, parser):
    ...
    @pytest.mark.asyncio
    @freeze_time("2025-07-05")
    async def test_parse_different_time_format(self, parser):
    ...
    @pytest.mark.asyncio
    async def test_parse_no_food_truck_info(self, parser):
    ...
    @pytest.mark.asyncio
    async def test_parse_case_insensitive_match(self, parser):
    ...
    @pytest.mark.asyncio
    async def test_parse_malformed_time_range(self, parser):
    ...
    @pytest.mark.asyncio
    async def test_parse_invalid_time_format(self, parser):
    ...
    @pytest.mark.asyncio
    async def test_parse_custom_pattern(self, parser):
        """Test parsing with custom regex pattern from config."""
        # Update parser config to use a different pattern
        parser.brewery.parser_config['pattern'] = r'Today.*?([A-Za-z\s]+?)\s+(\d+:\d+\s*-\s*\d+:\d+)'
    ...
    def test_parse_single_time_valid_formats(self, parser):
    ...
    def test_parse_single_time_invalid_formats(self, parser):
    ...
    def test_parse_time_range_valid_formats(self, parser):
    ...
    def test_parse_time_range_invalid_formats(self, parser):
    ...
    async def test_parse_network_error(self, parser):
        ...
        with aioresponses() as m:
            ...
            async with aiohttp.ClientSession() as session:
                with pytest.raises(ValueError, match="Failed to parse Obec Brewing website"):
    ...
    @pytest.mark.asyncio
    @freeze_time("2025-07-05")
    async def test_parse_multiple_food_truck_mentions(self, parser):
    ...
    @pytest.mark.asyncio
    async def test_parse_extra_whitespace(self, parser):
